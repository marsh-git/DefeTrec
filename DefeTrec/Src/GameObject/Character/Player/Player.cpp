...
//
//    // WASDキーで移動
//    if (input->IsKeyDown(KEY_INPUT_W) && state != WALK && moveCount >= 20) {
//        currentFrame = 0;
//        moveCount = 0;
//        int newTilePosY = pTilePosY - 1;
//
//        if (newTilePosY >= 0 && _mapData[pTilePosY - 1][pTilePosX] == 0) {
//            Slime* enemy = charMng->GetEnemyAtPosition(pTilePosX, pTilePosY - 1);
//            if (enemy == nullptr) {
...
//            }
//        }
//        // ポータル（8）に到達した場合、NextFloorを呼び出す
//        if (_mapData[pTilePosY - 1][pTilePosX] == 8) {
//            floorMng->NextFloor(0.15, 0.8, 0.05);  // 次の階層に移動
//        }
//    }
//    else if (input->IsKeyDown(KEY_INPUT_S) && state != WALK && moveCount >= 20) {
//        currentFrame = 0;
//        moveCount = 0;
//        int newTilePosY = pTilePosY + 1;
//
//        if (newTilePosY < MAP_HEIGHT && _mapData[pTilePosY + 1][pTilePosX] == 0) {
//            Slime* enemy = charMng->GetEnemyAtPosition(pTilePosX, pTilePosY + 1);
//            if (enemy == nullptr) {
//                charMng->CharacterData[pTilePosY][pTilePosX] = 0;
//                targetY = y + TILE_SIZE;
...
//        }
//    }
//    else if (input->IsKeyDown(KEY_INPUT_A) && state != WALK && moveCount >= 20) {
//        currentFrame = 0;
//        moveCount = 0;
//        int newTilePosX = pTilePosX - 1;
//
//        if (newTilePosX >= 0 && _mapData[pTilePosY][pTilePosX - 1] == 0) {
//            Slime* enemy = charMng->GetEnemyAtPosition(pTilePosX - 1, pTilePosY);
//            if (enemy == nullptr) {
//                charMng->CharacterData[pTilePosY][pTilePosX] = 0;
//                targetX = x - TILE_SIZE;
//                state = WALK;
...
//        }
//        // ポータル（8）に到達した場合、NextFloorを呼び出す
//        if (_mapData[pTilePosY][pTilePosX - 1] == 8) {
//            floorMng->NextFloor(0.15, 0.8, 0.05);  // 次の階層に移動
//        }
//    }
//    else if (input->IsKeyDown(KEY_INPUT_D) && state != WALK && moveCount >= 20) {
//        currentFrame = 0;
//        moveCount = 0;
//        int newTilePosX = pTilePosX + 1;
//
//        if (newTilePosX < MAP_WIDTH && _mapData[pTilePosY][pTilePosX + 1] == 0) {
//            Slime* enemy = charMng->GetEnemyAtPosition(pTilePosX + 1, pTilePosY);
//            if (enemy == nullptr) {
//                charMng->CharacterData[pTilePosY][pTilePosX] = 0;
//                targetX = x + TILE_SIZE;
